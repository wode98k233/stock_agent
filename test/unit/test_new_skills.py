...
def test_skill_discovery():
    ...
    new_skills = ['money_flow', 'margin_trading', 'sector_rotation', 'risk_metrics', 'block_trades']
    all_skills = sr.get_all_skills()
...
def test_skill_tool_building():
    ...
    expected = {
        ...
        'margin_trading': ['get_margin_summary', 'get_margin_detail'],
        'sector_rotation': ['get_sector_ranking', 'get_sector_history', 'get_sector_fund_flow'],
        'risk_metrics': ['get_risk_metrics'],
        'block_trades': ['get_block_trade_detail', 'get_block_trade_stats'],
    }
