...
def test_industry_sector_type():
    ...
    with patch.object(MXDataDataSource, '_query_mx') as mock_query:
        ...
        mock_query.assert_called_once_with("今日行业板块资金流向排名 主力净流入")
...
def test_concept_sector_type():
    ...
    with patch.object(MXDataDataSource, '_query_mx') as mock_query:
        ...
        mock_query.assert_called_once_with("今日概念板块资金流向排名 主力净流入")
...
def test_5day_indicator():
    ...
    with patch.object(MXDataDataSource, '_query_mx') as mock_query:
        ...
        mock_query.assert_called_once_with("5日概念板块资金流向排名 主力净流入")
...
def test_10day_indicator():
    ...
    with patch.object(MXDataDataSource, '_query_mx') as mock_query:
        ...
        mock_query.assert_called_once_with("10日行业板块资金流向排名 主力净流入")
